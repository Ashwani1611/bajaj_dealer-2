...
class ServiceBookingForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'service_station',      # ← Service station (not showroom)
            'showroom',             # ← Optional: preferred sales showroom
            'preferred_date',
            'issue_description',
        ]
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Custom labels
        self.fields['service_station'].label = 'Select Service Station'
        self.fields['service_station'].empty_label = '— Choose Service Station —'
        self.fields['showroom'].label        = 'Nearest Showroom (Optional)'
        self.fields['showroom'].empty_label  = '— Select Showroom (optional) —'
...
class ExchangeForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['showroom'].required      = False
        self.fields['interested_in'].empty_label = '— Select a Bajaj model —'
        self.fields['showroom'].empty_label      = '— Select nearest showroom —'